function initBanner(gl) {
    ...
    var width = BANNER_WIDTH;
    var length = BANNER_LENGTH;
    var height = BANNER_HEIGHT;
  ...
  function drawBanner(gl, programInfo, ground, deltaTime, projectionMatrix, texture){
