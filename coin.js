function initCoin(gl) {
    ...
    var width = COIN_WIDTH;
    var length = COIN_LENGTH;
    var height = COIN_HEIGHT;
  ...
  function drawCoin(gl, programInfo, coin, deltaTime, projectionMatrix, texture){

    var seconds = new Date().getTime() / 1000;
    
    rotation_angle = Math.PI/2.0 * Math.sin(seconds * 3);
    ...
    // buffer into the vertexPosition attribute
    {
      ...
      stride = 0;
      offset = 0;
      // console.log(coin.buffer.position)
    ...
    //   const stride = 0;
    //   const offset = 0;
    //   gl.bindBuffer(gl.ARRAY_BUFFER, coin.buffer.texture);
    //   gl.vertexAttribPointer(
