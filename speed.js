function initSpeed(gl) {
    ...
    var width = SPEED_POWERUP_WIDTH;
    var length = SPEED_POWERUP_LENGTH;
    var height = SPEED_POWERUP_HEIGHT;
  ...
  function drawSpeed(gl, programInfo, ground, deltaTime, projectionMatrix, texture){
